...
interface ItemConditions<Player> : RestrictionConditionsBuilder<Item, Player, Restriction> {
  ...
  fun replaceWith(replacement: ResourceLocation): ItemConditions<Player> {
    this.replacement = ItemRestriction.getValue(replacement)
    return this
  }
