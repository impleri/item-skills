...
class ItemRestriction private constructor(
  registry: RestrictionsRegistry<Restriction>,
  fields: Array<Field>,
) : RestrictionsApi<Item, Restriction>(registry, fields, ItemSkills.LOGGER) {
  ...
  companion object {
    internal val RestrictionRegistry = RestrictionsRegistry<Restriction>(ItemSkills.MOD_ID)

    private val allRestrictionFields = Restriction::class.java.declaredFields

    internal val INSTANCE = ItemRestriction(RestrictionRegistry, allRestrictionFields)
